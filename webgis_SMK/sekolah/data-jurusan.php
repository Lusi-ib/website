                    ...
                    if ($stmt) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>
                                        <a href='edit-jurusan.php?id_jurusan=" . $row['id_jurusan'] . "'>Edit</a> |
                                        <a href='hapus-jurusan.php?id_jurusan=" . $row['id_jurusan'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Hapus</a>
                                      </td>";
                                echo "</tr>";
                            }
                        } else {
